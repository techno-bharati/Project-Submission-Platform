...
import { FilePlus, FileText, LucideIcon, Menu } from "lucide-react";
...
const SIDEBAR_ITEMS: SidebarCategory[] = [
  {
    category: "Admin",
    items: [
      { href: "/admin/projects", icon: FileText, text: "Projects" },
      { href: "/admin/students", icon: FilePlus, text: "Students" }
    ]
  }
];
  ...
  return (
    <div className="space-y-4 md:space-y-6 relative z-20 flex flex-col h-full">
      ...
      <div className="flex flex-col w-full">
        ...
        <UserAccount user={session?.user} isAdmin={true} />
      </div>
    </div>
  );
};
